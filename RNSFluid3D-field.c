...
#define DOF 6   // 1 (log of) fluid density, 3 fluid, 1 d/dt scalar field, 1 scalar field

// resolution parameters
#define SIZE    (4*R0)                          // physical size in space
#define POINTS  25                             // number of points on lattice (each axis)
...
#define POINTS_TO_SAMPLE    25               // # of points along (x-)axis to sample

#define FILE_DATA_DIR   "/home/james/data/"     // directory where files go
